...
from simple_language.seq2seq_data.process_whole_sequence.SimpleLanguageModelWholeSeq import SimpleLanguageModelWholeSeq
...
# Model
model = SimpleLanguageModelWholeSeq(cfg['hidden_layer_size'], vocab_size, tokenizer, model_name
                                    )
...
# Checkpoint
path_to_checkpoint = os.path.join(os.curdir, 'BSLM_v2_whole_seq_lr1e-4')
# SLM_v4 lr=1e-4
