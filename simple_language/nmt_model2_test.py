...
dataset = tf.data.Dataset.from_tensor_slices((
    ...
    dict(input_ids=arr_lab['input_ids'],
         ...
         attention_mask=arr_lab['attention_mask']))).batch(1)
...
# Checkpoint
path_to_checkpoint = os.path.join(os.curdir, 'model_nmt_mix_v5')
...
test_target = tokenizer('[GO]', max_length=cfg['max_sentence'], padding='max_length', return_tensors='tf')
