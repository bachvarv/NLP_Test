...
class SimpleLanguageDecoder(Layer):
    def __init__(self, vocab_size, d_model, path_to_bert_model=None):
        super(SimpleLanguageDecoder, self).__init__()

        self.vocab_size = vocab_size
        self.d_model = d_model
        self.BERT_model = path_to_bert_model
