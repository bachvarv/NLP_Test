...
path_to_corpus = os.path.join(os.path.join(os.pardir, '..\\corpus'), 'einfache_sprache.csv')
path_to_corpus_2 = os.path.join(os.path.join(os.pardir, '..\\corpus'), 'spd_programm_einfache_sprache_v1.csv')
path_to_corpus_3 = os.path.join(os.path.join(os.pardir, '..\\corpus'), 'simple_language_openAI.csv')
longest_cand = 0
...
# Model
model = BertLanguageModelGeneral(cfg['hidden_layer_size'], vocab_size, tokenizer, path_to_model=model_name, bert_trainable=False)
...
# Checkpoint
path_to_checkpoint = os.path.join(os.curdir, 'BSLM_General_v1_freeze_BERT_lr1e-4')
# SLM_v4 lr=1e-4
