...
from simple_language.seq2seq_data.bahdanau.BertLanguageDecoder import BertLanguageDecoder
from simple_language.seq2seq_data.SimpleLanguageDecoder import DecoderInput


class BertLanguageModel(Model):
    def __init__(self, d_model, vocab_size, tokenizer, seq_length=128, path_to_model=None, bert_trainable=True):
        ...
        self.decoder = BertLanguageDecoder(self.vocab_size, self.d_model)
